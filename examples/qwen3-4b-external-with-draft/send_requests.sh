#!/bin/bash
# Send user requests to the external sglang server — Qwen3-4B (with draft)
#
...
#
# Usage:
#   bash examples/qwen3-4b-external-with-draft/send_requests.sh [EXTRA_ARGS...]
#
...
CHAT_TEMPLATE="${CHAT_TEMPLATE:-Qwen/Qwen3-4B}"

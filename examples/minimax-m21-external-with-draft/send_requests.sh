#!/bin/bash
# Send user requests to the external sglang server — MiniMax-M2.1 (with draft)
#
...
#
# Usage:
#   bash examples/minimax-m21-external-with-draft/send_requests.sh [EXTRA_ARGS...]
#
...
DATASET="${DATASET:-$ROOT_DIR/datasets/onlinesd/merged/merged_train_data_shuffled.jsonl}"
MODEL="${MODEL:-MiniMaxAI/MiniMax-M2.1}"
CHAT_TEMPLATE="${CHAT_TEMPLATE:-MiniMaxAI/MiniMax-M2.1}"

#!/bin/bash
# Send user requests to the external sglang server — Qwen3-Coder-Next (no draft)
#
...
#
# Usage:
#   bash examples/qwen3-next-coder-external-no-draft/send_requests.sh [EXTRA_ARGS...]
#
